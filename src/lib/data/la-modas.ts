...
// Cliente novo: painel criado com a mesma estrutura padrão dos demais clientes (mesmas
// classificações/categorias como modelo inicial), mas sem nenhum lançamento ainda — os dados
// reais entram conforme forem enviados.
export const laModasData: ClientFinanceData = {
  deducoesManuais: {
    impostos: 0,
    inadimplencia: 0,
    investimentos: 0,
  ...
  destaquesPeriodo: [],
  resumoExecutivo: ["Ainda não há lançamentos cadastrados para a LA Modas — os dados aparecem aqui assim que forem lançados."],
  ...
  seedCategoriasPagar: [
    ...
    },
    {
      ...
      color: "#fb923c",
      padrao: true,
      categorias: [{ nome: "Pagamentos a Fornecedores", padrao: true }],
    },
    {
