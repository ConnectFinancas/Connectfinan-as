...
export const everShoppingData: ClientFinanceData = {
  deducoesManuais: {
    impostos: 0,
    inadimplencia: 0,
    investimentos: 0,
  ...
  destaquesPeriodo: [],
  resumoExecutivo: ["Ainda não há lançamentos cadastrados para a Ever Shopping — os dados aparecem aqui assim que forem lançados."],
