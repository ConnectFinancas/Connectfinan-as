...
const STYLES: Record<Status, { label: string; bg: string; fg: string; dot: string }> = {
  pago: { label: "Pago", bg: "bg-accent-100", fg: "text-accent-600", dot: "bg-accent-500" },
  ...
  conciliado: { label: "Conciliado", bg: "bg-accent-100", fg: "text-accent-600", dot: "bg-accent-500" },
